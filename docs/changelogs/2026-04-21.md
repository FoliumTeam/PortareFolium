...
- `AGENTS.md`, `.agents/skills/ship/SKILL.md`, `docs/TEST.md`, `README.md`: Testing Gate / Push gate 섹션을 CI-driven에서 로컬 strict로 재작성. `R2_PUBLIC_URL`을 필수 `.env.local` 항목에 추가
